...
/********************************************************************************
** Form generated from reading UI file 'FractionClassGUIQtjcSxGm.ui'
**
...
#ifndef FRACTIONCLASSGUIQTJCSXGM_H
#define FRACTIONCLASSGUIQTJCSXGM_H
...
public:
	...
	void setupUi(QMainWindow *FractionClassGUIQtClass)
	{
		...
		calculate->setGeometry(QRect(20, 168, 75, 23));
		...
		realtime = new QCheckBox(centralWidget);
		realtime->setObjectName(QStringLiteral("realtime"));
		realtime->setGeometry(QRect(120, 172, 70, 17));
	...
	void retranslateUi(QMainWindow *FractionClassGUIQtClass)
	{
		...
		realtime->setText(QApplication::translate("FractionClassGUIQtClass", "Real-time", nullptr));
	} // retranslateUi
...
#endif // FRACTIONCLASSGUIQTJCSXGM_H

class FractionClassGUIQt : public QMainWindow
{
	Q_OBJECT

public:
	FractionClassGUIQt(QWidget *parent = Q_NULLPTR);
private slots:
	void Calculate();
	void ChangeMode(bool realtime);
private:
	Ui::FractionClassGUIQtClass ui;
};